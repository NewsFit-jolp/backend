...
public class TokenService {
    ...
    // access 토큰 재생성
    public String reissueAccessToken(Authentication auth) {
        MemberDetailsImpl memberDetailsImpl = ((MemberDetailsImpl) auth.getPrincipal());
        return createAccessToken(memberDetailsImpl);
    }
